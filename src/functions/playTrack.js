...
module.exports = async (d) => {
    ...
    switch (res?.loadType) {
        ...
        case LoadType.PLAYLIST: {
            if (debug && debug == 'true') data.result = 'playlist';
        ...
        case LoadType.SEARCH: {
            if (debug && debug == 'true') data.result = 'search';
